...
| [0004](0004-dockerfile-builds.md) | Dockerfile builds (BuildKit) | implementable |
| [0005](0005-shell-and-one-off-commands.md) | Shell and one-off commands | implementable |
